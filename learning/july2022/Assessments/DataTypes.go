...
func DataTypes() {
	...
	//Activity 3
	var P, r, n, t float64
	var initialDeposit, interestS, numYearInterst, numYear string
	...
	r, _ = strconv.ParseFloat(interestS, 64)
	...
	inputFloat = math.Sqrt(float64(value))
	in64 := int64(value)
	inputBin := strconv.FormatInt(in64, 2)
	fmt.Println("You selected value: ", input)
	fmt.Println("The boolean of your number is true") //a boolean value of a number?
	fmt.Println("The binary equivalent of your number is ", inputBin)
	fmt.Println("The square root of your number is ", inputFloat)
